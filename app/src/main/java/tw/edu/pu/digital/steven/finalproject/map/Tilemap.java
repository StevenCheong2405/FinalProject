...
import static tw.edu.pu.digital.steven.finalproject.map.MapLayout.NUMBER_OF_COLUMN_TILES;
import static tw.edu.pu.digital.steven.finalproject.map.MapLayout.NUMBER_OF_ROW_TILES;
import static tw.edu.pu.digital.steven.finalproject.map.MapLayout.TILE_HEIGHT_PIXELS;
import static tw.edu.pu.digital.steven.finalproject.map.MapLayout.TILE_WIDTH_PIXELS;
